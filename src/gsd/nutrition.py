#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""nutrition.py -- DER/Gompertz/matrix build. Imports core only."""
...
__all__ = [
    # Constants
    "SOLVER_NUTRIENTS", "SCENARIO_K_MAP", "SUPPLEMENTS_PLANNED",
    "VALID_NUTRIENT_STATUSES",
    # Functions
    ...
    "get_ingredient_by_id", "get_bioavailability_factor",
    "get_global_density_range_from_db", "gompertz_weight",
]
