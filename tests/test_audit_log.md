...
- **Expected:** suboptimal
- **Got:** solver_status=structurally_infeasible, level=None, gaps=0, allocations=null (Level 3 — mechanical barrier)
- **Passed:** False
...
- **Expected:** structurally_infeasible (awaiting bone ingredients)
- **Got:** solver_status=structurally_infeasible, level=None, gaps=0, allocations=null (Level 3 — mechanical barrier)
- **Passed:** False
...
## test_cascade_level2_triggered_by_unbalanced_selection
- **Expected:** suboptimal
- **Got:** solver_status=suboptimal, level=2, gaps=0, allocations=2 items
- **Passed:** True
...
## test_single_ingredient_returns_result
- **Expected:** non-blank
- **Got:** solver_status=suboptimal, level=2, gaps=0, allocations=1 items
- **Passed:** False
...
- **Got:** solver_status=suboptimal, level=2, gaps=0, allocations=4 items
- **Passed:** False
