#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""solver.py -- LP cascade + output contract. Imports core + nutrition_pipeline."""

from typing import Any, Dict, List, Optional, Tuple

from core import DerEnvelope, UNIT_RENAME, AnimalInput
from nutrition_pipeline import get_ingredient_by_id, build_matrix, energy_metabolizable_kcal_per_100g
